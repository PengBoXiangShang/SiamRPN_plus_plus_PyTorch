...
class RPN(nn.Module):
    ...
    def forward(self, examplar_feature_map, search_region_feature_map, BATCH_SIZE):
        ...
        # ipdb.set_trace()
        # TODO
        adj_1_output = adj_1_output.reshape(-1, 8, 8)
